...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-PBlack">
      ...
      >
        <p className="text-center text-sm lg:text-base">{t(`footer.rights`)}</p>
        <div className="flex items-center justify-start gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-12 items-center rounded-full bg-PGreyDark transition ${styles.focus}`}
            >
              <span
